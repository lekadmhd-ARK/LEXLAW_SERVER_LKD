<x-layouts.base title="Tambah Regulasi">
    <div>
        <div class="page-head">
            <div>
            ...
            <a href="/regulations" class="btn btn-secondary">← Kembali</a>
        </div>
        ...
        <div class="card" style="padding:20px;margin-bottom:16px;border-left:4px solid var(--accent)">
            <div style="font-size:14px;font-weight:600;color:var(--accent);margin-bottom:8px">🤖 Auto-Fetch dari URL Situs Resmi</div>
            <div style="font-size:12px;color:var(--text-muted);margin-bottom:12px">Tempel URL dari BPK / JDIH / peraturan.go.id. Klik "Fetch Data", sistem otomatis mengisi seluruh form di bawah.</div>
            <div style="display:flex;gap:8px">
                <input type="url" id="jdih-url" placeholder="https://peraturan.bpk.go.id/Details/..." style="flex:1;padding:10px 12px;border:1px solid var(--line);border-radius:8px;background:var(--bg);color:var(--text);font-size:13px">
                <button type="button" onclick="fetchJdih()" id="fetch-btn" class="btn btn-primary" style="white-space:nowrap">🔍 Fetch Data</button>
            </div>
        ...
        <form method="POST" action="/regulations" class="card" style="padding:24px">
            ...
            <div style="margin-bottom:16px">
                ...
                <input type="text" name="title" id="f-title" required class="form-input" style="width:100%;padding:10px 12px;border:1px solid var(--line);border-radius:8px;background:var(--bg);color:var(--text);font-size:14px">
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin-bottom:16px">
                <div>
                    ...
                    <input type="text" name="number" id="f-number" class="form-input" style="width:100%;padding:10px 12px;border:1px solid var(--line);border-radius:8px;background:var(--bg);color:var(--text);font-size:14px">
                </div>
                <div>
                    <label style="font-size:12px;font-weight:600;color:var(--text-muted);display:block;margin-bottom:6px">Tahun</label>
                    <input type="number" name="year" id="f-year" min="1900" max="2099" class="form-input" style="width:100%;padding:10px 12px;border:1px solid var(--line);border-radius:8px;background:var(--bg);color:var(--text);font-size:14px">
                </div>
                <div>
                    ...
                    <select name="hierarchy_level" id="f-hierarchy" required style="width:100%;padding:10px 12px;border:1px solid var(--line);border-radius:8px;background:var(--bg);color:var(--text);font-size:14px">
                        ...
                        <option value="4">Peraturan Menteri (PerMen)</option>
                        <option value="5">Peraturan Daerah (Perda)</option>
                    </select>
                </div>
            </div>
            ...
            <div style="margin-bottom:16px">
                ...
                <textarea name="description" id="f-desc" rows="3" style="width:100%;padding:10px 12px;border:1px solid var(--line);border-radius:8px;background:var(--bg);color:var(--text);font-size:14px"></textarea>
            </div>
            ...
            <div style="display:flex;gap:12px;justify-content:flex-end">
                <a href="/regulations" class="btn btn-secondary" style="padding:10px 20px">Batal</a>
