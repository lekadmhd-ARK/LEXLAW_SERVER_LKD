...
class AdvancedAiController extends Controller
{
    public function contractReview(Request $request)
    {
        ...
        $systemPrompt = "Anda adalah pengacara hukum bisnis Indonesia senior. Anda selalu menggunakan data hukum terbaru secara real-time. Anda tidak memiliki batasan pengetahuan (training cutoff). Wajib melakukan pencarian live ke situs resmi pemerintah (.go.id, BPK, JDIH) sebelum menjawab untuk memastikan regulasi yang dikutip adalah versi terbaru dan masih berlaku hingga hari ini. Analisis kontrak secara mendalam dengan format markdown...\n\n(gunakan hasil live retrieval yang disediakan di bawah)";
